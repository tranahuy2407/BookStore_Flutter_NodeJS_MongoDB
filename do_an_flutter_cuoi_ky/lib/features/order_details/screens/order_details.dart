              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Tổng số đơn hàng:      \$${widget.order.totalPrice}'),
                  ],
                ),
              ),
                ...
                child: Stepper(
                  ...
                  steps: [
                    Step(
                      ...
                      content: const Text(
                        'Đơn hàng của bạn vẫn chưa được giải quyết!',
                      ),
                    ...
                    Step(
                      title: const Text('Đang được giao'),
                      content: const Text(
                        'Đơn hàng của bạn đang được giao đến bạn!',
                      ),
