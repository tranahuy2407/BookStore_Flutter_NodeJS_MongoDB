...
import 'package:do_an_flutter_cuoi_ky/features/admin/models/sales.dart';
...
class AdminServices {
  void sellProduct({
    ...
    try {
      final cloudinary = CloudinaryPublic('dmcfhbwbb', 'yznfezyj');
      ...
      httpErrorHandle(
        ...
        context: context,
        onSuccess: () {
          showSnackBar(context, 'Thêm sách thành công!');
    ...
    try {
      ...
      httpErrorHandle(
        ...
        onSuccess: () {
          ...
          sales = [
            Sales('Giáo khoa', response['mobileEarnings']),
            Sales('Truyện tranh', response['essentialEarnings']),
            Sales('Lịch sử', response['booksEarnings']),
            Sales('Văn học', response['applianceEarnings']),
            Sales('Tâm lý', response['fashionEarnings']),
          ];
        },
      );
    } catch (e) {
